...
class TransformerBlock(nn.Module):
    def __init__(
        ...
        init_cfg = dev_utils.make_dictconfig(
            init_cfg, default={"layer_norm": None, "attention": None, "ffn": None}
        )
    ...
    @property
    def act_fn(self):
        return self.ffn.act_fn

    @property
    def ffn_dim(self):
        return self.ffn.ffn_dim
    ...
    @property
    def ffn_type(self):
        return self.ffn.ffn_type

    @property
    def use_bias(self):
        return self.attention.use_bias and self.ffn.use_bias

    @property
    def use_RoPE(self):
        return self.attention.use_RoPE

    @property
    def RoPE_base(self):
        return self.attention.RoPE_base
    ...
    def activation_name(self):
        return self.ffn.activation_name
